...
#c# 4-switch synchronous buck-boost topology with paralleled MOSFETs
...
$f_sw     [int]= 200k   #c# switching frequency (reduced for high current)

#c# Current sense: 50mV threshold / 35A peak = ~1.43mOhm
$r_sense  [real]= 1.5m   #c# current sense resistance
$r_freq   [int]= 150k   #c# frequency set resistor (~200kHz)
...
#c# =====================================================================
#c# POWER MOSFETs - 4x paralleled per position for 30A+ capability
#c# =====================================================================
...
#c# =====================================================================
#c# INPUT CAPACITORS - Low ESR ceramic + bulk electrolyte
#c# =====================================================================
...
#c# RUN enable (jumper to Vin through R15)
...
#c# GATE DRIVERS
#c# =====================================================================
#c# Driver U2 drives Q1 (input high-side) and Q2 (input low-side)
...
#c# Driver U3 drives Q3 (output high-side) and Q4 (output low-side)
...
#c# Power planes on layers 1 and 4
phys.layer { Vin } 0 -imp
phys.layer { Vout } 5 -imp

#c# Ground planes on layers 2 and 5
phys.mkplane 2 Gnd
phys.mkplane 5 Gnd

#c# Via stitching for thermal and current sharing
...
#c# Align MOSFET groups for thermal management
