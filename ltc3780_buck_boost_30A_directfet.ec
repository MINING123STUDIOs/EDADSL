...
# 4-switch synchronous buck-boost topology with DirectFET MOSFETs
...
$r_freq   [int]= 100k   # frequency set resistor (~300kHz)
...
# =====================================================================
# POWER MOSFETs - DirectFET, 0.5mOhm, 3x paralleled per position
# =====================================================================
...
# =====================================================================
# INPUT CAPACITORS - Low ESR ceramic + bulk polymer
# =====================================================================
...
# RUN enable (jumper to Vin through R14)
...
# GATE DRIVERS
# =====================================================================
# Driver U2 drives Q1 (input high-side P-channel)
...
# Driver U3 drives Q2 (input low-side N-channel)
...
# Driver U4 drives Q3 (output high-side P-channel)
...
# Driver U5 drives Q4 (output low-side N-channel)
...
# Power planes on layers 0 and 8
phys.layer { Vin } 0 -imp
phys.layer { Vout } 8 -imp

# Ground planes on layers 3 and 6
phys.mkplane 3 Gnd
phys.mkplane 6 Gnd

# Via fill on DirectFET thermal pads
...
# Align DirectFET groups for thermal management
