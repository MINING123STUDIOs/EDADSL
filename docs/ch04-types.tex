...
\item \texttt{~.T} — transpose in place
\item \texttt{.H} — conjugate transpose (postfix operator)
\item \texttt{~.H} — conjugate transpose in place
\item \texttt{~.E} — erase (sets variable to null)
...
\item Linear algebra: \texttt{f.linalg.det}, \texttt{f.linalg.inv}, \texttt{f.linalg.pinv}, \texttt{f.linalg.rank}, \texttt{f.linalg.trace}, \texttt{f.linalg.solve}, \texttt{f.linalg.eig}, \texttt{f.linalg.eigvec}, \texttt{f.linalg.lu}, \texttt{f.linalg.qr}, \texttt{f.linalg.chol}, \texttt{f.linalg.svd}, \texttt{f.linalg.cond}
\end{itemize}
...
\begin{verbatim}
5 as complex       #c# Returns 5 + 0i
-3 as complex      #c# Returns -3 + 0i
\end{verbatim}

\paragraph{real as complex}
Promotes a real to complex with zero imaginary part.
\begin{verbatim}
3.14 as complex    #c# Returns 3.14 + 0i
\end{verbatim}
...
\begin{verbatim}
(3 + 0i) as real   #c# Returns 3.0
(3 + 4i) as real   #c# Warning: imaginary part lost; returns 5.0
\end{verbatim}
...
\begin{verbatim}
(5 + 0i) as int    #c# Returns 5
(3.7 + 0i) as int  #c# Returns 3
(3 + 4i) as int    #c# Warning: imaginary part lost; returns 3
\end{verbatim}
