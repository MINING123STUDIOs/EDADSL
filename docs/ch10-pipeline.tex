...
The reference implementation is written in Rust for performance and safety. Current version: 0.1.0 (pre-release). Supported platforms: Linux (x86\_64), macOS (x86\_64, aarch64), Windows (x86\_64).

\section{Build and Installation}
The reference implementation can be built from source using Cargo:
\begin{verbatim}
cargo build --release
\end{verbatim}
